...
Sed nec ligula sem. Vestibulum non mauris metus. Nullam quis lectus at felis tempus sollicitudin. Mauris dignissim eros nunc, consequat sollicitudin magna faucibus ac. Integer iaculis turpis ac orci efficitur, a pulvinar libero sodales. Vivamus nec nunc posuere quam fermentum sodales. Sed eu ultrices risus. Maecenas aliquet rhoncus iaculis. Ut sed nulla sodales, ornare turpis non, varius eros.''';
  ...
  radioClick _radio = radioClick.Yes;
                              ...
                              InputTextField(
                                ...
                                validator: (String? value) {
                                  ...
                                  if (value?.isEmpty == true) {
                                    validations["error"] = true;
                                    validations["message"] =
                                        "Enter valid organization address";
                                  }
                            ...
                            children: [
                              ...
                              InputTextField(
                                ...
                                validator: (String? value) {
                                  ...
                                  if (value?.isEmpty == true) {
                                    validations["error"] = true;
                                    validations["message"] = "Enter title";
                                  }
                              ...
                              InputTextField(
                                ...
                                validator: (String? value) {
                                  ...
                                  if (value?.isEmpty == true) {
                                    validations["error"] = true;
                                    validations["message"] = "Enter first name";
                                  }
                              ...
                              InputTextField(
                                ...
                                validator: (String? value) {
                                  ...
                                  if (value?.isEmpty == true) {
                                    validations["error"] = true;
                                    validations["message"] = "Enter last name";
                                  }
                              ...
                              InputTextField(
                                ...
                                validator: (String? value) {
                                  ...
                                  if (value?.isEmpty == true) {
                                    validations["error"] = true;
                                    validations["message"] = "Enter address";
                                  }
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Radio(
                                        value: radioClick.Yes,
                                        groupValue: _radio,
                                        onChanged: (value) {
                                          setState(() {
                                            _radio = radioClick.Yes;
                                          });
                                        }),
                                    const Padding(
                            ...
                            children: [
                              InputTextField(
                                ...
                                validator: (String? value) {
                                  ...
                                  if (value?.isEmpty == true) {
                                    validations["error"] = true;
                                    validations["message"] = "Enter Password";
                                  }
                              ...
                              CheckboxListTile(
                                ...
                                title: RichText(
                                  text: TextSpan(
                                      text:
                                          'By checking this box, you agree to be \nbound'
                                          ' by our',
